  ...
  <div class="_1usHJaFWWn4E6WcS4Kqg8c">
    <div class="_3zdnpg033Uf7k-qsiPg_NU">
      ...
      <form action="admin/users/sua/{{$users->id}}" method="POST">
        ...
        <div style="display: block;">
          <p>Email:<input type="text"  placeholder="Nhập Email.." name="email" style="border-top: none; display: block; width: 100%;" value="{{$users->email}}" readonly></p>
        </div>
        <br>
        ...
        <div style="display: block;">
          ...
          <p><input id = "changepw" type="checkbox" name="changepw"> &nbsp Đổi mật khẩu:<input type="password"  placeholder="Nhập mật khẩu.." name="pw" style="border-top: none; display: block; width: 100%;" value="" disabled="" class="password"></p>
        </div>
        <br>

         <div style="display: block;">
          <p>Nhập lại mật khẩu:<input type="password"  placeholder="Nhập lại mật khẩu.." name="rpw" style="border-top: none; display: block; width: 100%;" value="" disabled="" class="password"></p>
        </div>
        <br>
